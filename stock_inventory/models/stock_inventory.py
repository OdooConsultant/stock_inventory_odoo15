...
class Inventory(models.Model):
    ...
    marque_ids = fields.Many2many('product.brand', string='Marque', readonly=True, states={'draft': [('readonly', False)]})
    ...
    total_valorisation = fields.Float(string='Total Valorisation', compute='_compute_total_valorisation')
